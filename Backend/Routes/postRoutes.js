const express = postRouter.get('/v1/post/:id', getSinglePost);
postRouter.get('/v1/timeline', getAllPost);
postRouter.get('/v1/post/user/:username', getUserPost);
postRouter.post(
  '/v1/post/create',
  isAuthenticated,
...
postRouter.put('/v1/post/:id', isAuthenticated, editPost);
postRouter.delete('/v1/post/:id', isAuthenticated, deletePost);
postRouter.post('/v1/like/:id', isAuthenticated, likeUnlikePost);
('express');
